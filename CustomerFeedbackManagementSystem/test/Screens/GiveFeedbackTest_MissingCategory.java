...
public class GiveFeedbackTest_MissingCategory {
    ...
    //Checks Submit Button action event with missing category and correct expected result
    @Test
    public void testGiveFeedbackMissingCategoryPositive() {
    ...
    //Checks Submit Button action event without choosing a category and incorrect expected result
    @Test
    public void testGiveFeedbackMissingCategoryNegative() {
